...
- eg-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- eg-ui: main application module, development time
- eg-production: module that produces a production mode WAR for deployment
